...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final int DATABASE_VERSION = 2; // Updated version number
    ...
    public static final String BUS_COL_12 = "ORIGIN_CITY";
    public static final String BUS_COL_13 = "DESTINATION_CITY";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        // Membuat tabel buses
        db.execSQL("CREATE TABLE " + TABLE_NAME_BUSES + " (BUS_ID INTEGER PRIMARY KEY AUTOINCREMENT, BUS_NAME TEXT, BUS_CLASS TEXT, DEPARTURE_DATE TEXT, DEPARTURE_TIME TEXT, ARRIVAL_TIME TEXT, PRICE INTEGER, TOTAL_SEATS INTEGER, FACILITIES TEXT, ABOUT_BUS TEXT, TERMS_AND_CONDITIONS TEXT, ORIGIN_CITY TEXT, DESTINATION_CITY TEXT)");
    }
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        if (oldVersion < 2) {
            ...
            db.execSQL("ALTER TABLE " + TABLE_NAME_BUSES + " ADD COLUMN ORIGIN_CITY TEXT");
            db.execSQL("ALTER TABLE " + TABLE_NAME_BUSES + " ADD COLUMN DESTINATION_CITY TEXT");
        }
    }
    ...
    public boolean insertBusData(String busName, String busClass, String departureDate, String departureTime, String arrivalTime, int price, int totalSeats, String facilities, String aboutBus, String termsAndConditions, String originCity, String destinationCity) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        ...
        contentValues.put(BUS_COL_12, originCity);
        contentValues.put(BUS_COL_13, destinationCity);
